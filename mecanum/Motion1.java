...
public class Motion1 {
    ...
    public Motion1(HardwareMap hardwareMap, Telemetry t, boolean runtoposition) {

        /* Initialize the hardware variables. Note that the strings used here as parameters
         * to 'get' must correspond to the names assigned during the robot configuration
         * step (using the FTC Robot Controller app on the phone).
         */
        left_back = hardwareMap.get(DcMotorEx.class, "BL");
        right_back = hardwareMap.get(DcMotorEx.class, "BR");
        left_front = hardwareMap.get(DcMotorEx.class, "FL");
        right_front = hardwareMap.get(DcMotorEx.class, "FR");
